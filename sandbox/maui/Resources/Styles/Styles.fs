...
NOTE ABOUT THIS FILE:
   ...
   the styles are stored using resource ids (synthings.sandbox.maui.Resources.Styles.XXX.xaml) so Maui uses XamlResourceId
   ...
   - Add a class name inside the XAML (<ResourceDictionary x:Class="synthings.sandbox.maui.XXX">)
   - Create a new type in this file:
    ...
    - Register the XAML file and this type by adding a XamlResourceId attribute below
        - ResourceId must follow format: Namespace.Folder.SubFolder.FileName.Extension (synthings.sandbox.maui.Resources.Styles.XXX.xaml)
...
[<XamlResourceId("synthings.sandbox.maui.Resources.Styles.Colors.xaml", "Resources/Styles/Colors.xaml", typeof<Colors>)>]
[<XamlResourceId("synthings.sandbox.maui.Resources.Styles.Styles.xaml", "Resources/Styles/Styles.xaml", typeof<Styles>)>]
do ()
